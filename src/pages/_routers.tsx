...
import TrafficTracerPage from './traffic-tracer/lazy'
...
export const navItems = [
  ...
  {
    label: 'layout.components.navigation.tabs.trafficTracer',
    path: '/traffic-tracer',
    icon: [
      <TimelineRoundedIcon key="mui" />,
      <TimelineRoundedIcon key="color" color="primary" />,
    ],
    Component: TrafficTracerPage,
  },
  {
