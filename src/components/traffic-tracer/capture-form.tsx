    ...
    <Stack spacing={2}>
      ...
      <Paper variant="outlined" sx={{ p: 2 }}>
        <Stack spacing={2}>
          ...
          <TextField
            ...
            helperText={
              draft.options.pcap_split_mode === 'none'
                ...
                : 'Full also generates per-connection pre/post PCAP files during analysis.'
            }
            onChange={(event) =>
              setDraft((current) => ({
                ...current,
          ...
          >
            <MenuItem value="none">Standard (recommended)</MenuItem>
            <MenuItem value="unique_connections">Full</MenuItem>
          </TextField>
