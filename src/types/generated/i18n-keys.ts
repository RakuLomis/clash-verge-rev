...
export const translationKeys = [
  ...
  'settings.trafficTracer.title',
  'settings.trafficTracer.notifications.captureStarted',
  'settings.trafficTracer.notifications.analysisStarted',
  'settings.trafficTracer.common.actions.analyzeAgain',
  'settings.trafficTracer.common.actions.browse',
  'settings.trafficTracer.common.actions.cancel',
  'settings.trafficTracer.common.actions.cancelJob',
  'settings.trafficTracer.common.actions.close',
  'settings.trafficTracer.common.actions.keepRunning',
  'settings.trafficTracer.common.actions.open',
  'settings.trafficTracer.common.actions.openDirectory',
  'settings.trafficTracer.common.actions.queryAll',
  'settings.trafficTracer.common.actions.refresh',
  'settings.trafficTracer.common.actions.retry',
  'settings.trafficTracer.common.actions.startCapture',
  'settings.trafficTracer.common.actions.checkEnvironment',
  'settings.trafficTracer.common.progress.canceling',
  'settings.trafficTracer.common.progress.opening',
  'settings.trafficTracer.common.progress.querying',
  'settings.trafficTracer.common.progress.starting',
  'settings.trafficTracer.common.states.created',
  'settings.trafficTracer.common.states.preparing',
  'settings.trafficTracer.common.states.capturing',
  'settings.trafficTracer.common.states.analyzing',
  'settings.trafficTracer.common.states.completed',
  'settings.trafficTracer.common.states.failed',
  'settings.trafficTracer.common.states.cancelled',
  'settings.trafficTracer.common.states.interrupted',
  'settings.trafficTracer.common.states.ready',
  'settings.trafficTracer.common.states.warning',
  'settings.trafficTracer.common.states.blocked',
  'settings.trafficTracer.common.states.unknown',
  'settings.trafficTracer.common.states.enabled',
  'settings.trafficTracer.common.states.disabled',
  'settings.trafficTracer.common.states.notChecked',
  'settings.trafficTracer.common.states.complete',
  'settings.trafficTracer.common.states.incomplete',
  'settings.trafficTracer.locks.captureActive',
  'settings.trafficTracer.locks.coreTracing',
  'settings.trafficTracer.locks.profiles',
  'settings.trafficTracer.locks.proxyLifecycle',
  'settings.trafficTracer.locks.job',
  'settings.trafficTracer.environment.title',
  'settings.trafficTracer.environment.description',
  'settings.trafficTracer.environment.diagnosticsFailed',
  'settings.trafficTracer.environment.checkAgain',
  'settings.trafficTracer.environment.changed',
  'settings.trafficTracer.environment.labels.core',
  'settings.trafficTracer.environment.labels.controller',
  'settings.trafficTracer.environment.labels.tun',
  ...
  'settings.trafficTracer.environment.labels.chrome',
  'settings.trafficTracer.environment.labels.output',
  'settings.trafficTracer.environment.values.localController',
  'settings.trafficTracer.environment.values.notSelected',
  'settings.trafficTracer.environment.values.tunServiceReady',
  'settings.trafficTracer.environment.values.tunServiceUnavailable',
  'settings.trafficTracer.environment.values.automaticTun',
  'settings.trafficTracer.environment.actions.retry',
  'settings.trafficTracer.environment.actions.fix',
  'settings.trafficTracer.environment.diagnostics.RECOVERY_DEGRADED.message',
  'settings.trafficTracer.environment.diagnostics.RECOVERY_DEGRADED.remediation',
  'settings.trafficTracer.environment.diagnostics.CORE_NOT_TRAFFIC_TRACER.message',
  'settings.trafficTracer.environment.diagnostics.CORE_NOT_TRAFFIC_TRACER.remediation',
  'settings.trafficTracer.environment.diagnostics.CORE_ENDPOINT_MISSING.message',
  'settings.trafficTracer.environment.diagnostics.CORE_ENDPOINT_MISSING.remediation',
  'settings.trafficTracer.environment.diagnostics.CORE_TRACING_UNAVAILABLE.message',
  'settings.trafficTracer.environment.diagnostics.CORE_TRACING_UNAVAILABLE.remediation',
  'settings.trafficTracer.environment.diagnostics.CORE_CAPABILITY_MISMATCH.message',
  'settings.trafficTracer.environment.diagnostics.CORE_CAPABILITY_MISMATCH.remediation',
  'settings.trafficTracer.environment.diagnostics.TUN_SERVICE_UNAVAILABLE.message',
  'settings.trafficTracer.environment.diagnostics.TUN_SERVICE_UNAVAILABLE.remediation',
  'settings.trafficTracer.environment.diagnostics.TUN_DISABLED.message',
  'settings.trafficTracer.environment.diagnostics.TUN_DISABLED.remediation',
  'settings.trafficTracer.environment.diagnostics.TUN_INTERFACE_NOT_CONFIGURED.message',
  'settings.trafficTracer.environment.diagnostics.TUN_INTERFACE_NOT_CONFIGURED.remediation',
  'settings.trafficTracer.environment.diagnostics.TUN_INTERFACE_ENUMERATION_FAILED.message',
  'settings.trafficTracer.environment.diagnostics.TUN_INTERFACE_ENUMERATION_FAILED.remediation',
  'settings.trafficTracer.environment.diagnostics.TUN_INTERFACE_NOT_FOUND.message',
  'settings.trafficTracer.environment.diagnostics.TUN_INTERFACE_NOT_FOUND.remediation',
  'settings.trafficTracer.environment.diagnostics.PHYSICAL_INTERFACE_NOT_CONFIGURED.message',
  'settings.trafficTracer.environment.diagnostics.PHYSICAL_INTERFACE_NOT_CONFIGURED.remediation',
  'settings.trafficTracer.environment.diagnostics.PHYSICAL_INTERFACE_ENUMERATION_FAILED.message',
  'settings.trafficTracer.environment.diagnostics.PHYSICAL_INTERFACE_ENUMERATION_FAILED.remediation',
  'settings.trafficTracer.environment.diagnostics.PHYSICAL_INTERFACE_NOT_FOUND.message',
  'settings.trafficTracer.environment.diagnostics.PHYSICAL_INTERFACE_NOT_FOUND.remediation',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_TOOL_NOT_FOUND.message',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_TOOL_NOT_FOUND.remediation',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_TOOL_CHECK_FAILED.message',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_TOOL_CHECK_FAILED.remediation',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_PERMISSION_DENIED.message',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_PERMISSION_DENIED.remediation',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_TOOL_UNAVAILABLE.message',
  'settings.trafficTracer.environment.diagnostics.CAPTURE_TOOL_UNAVAILABLE.remediation',
  'settings.trafficTracer.environment.diagnostics.CHROME_NOT_EXECUTABLE.message',
  'settings.trafficTracer.environment.diagnostics.CHROME_NOT_EXECUTABLE.remediation',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_MISSING.message',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_MISSING.remediation',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_NOT_ABSOLUTE.message',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_NOT_ABSOLUTE.remediation',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_INVALID.message',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_INVALID.remediation',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_NOT_WRITABLE.message',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_NOT_WRITABLE.remediation',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_WILL_CREATE.message',
  'settings.trafficTracer.environment.diagnostics.OUTPUT_DIRECTORY_WILL_CREATE.remediation',
  'settings.trafficTracer.environment.diagnostics.DISK_THRESHOLD_INVALID.message',
  'settings.trafficTracer.environment.diagnostics.DISK_THRESHOLD_INVALID.remediation',
  'settings.trafficTracer.environment.diagnostics.DISK_SPACE_UNAVAILABLE.message',
  'settings.trafficTracer.environment.diagnostics.DISK_SPACE_UNAVAILABLE.remediation',
  'settings.trafficTracer.environment.diagnostics.DISK_SPACE_LOW.message',
  'settings.trafficTracer.environment.diagnostics.DISK_SPACE_LOW.remediation',
  'settings.trafficTracer.capture.title',
  'settings.trafficTracer.capture.description',
  'settings.trafficTracer.capture.selectChrome',
  'settings.trafficTracer.capture.selectOutput',
  'settings.trafficTracer.capture.selectTargetConfig',
  'settings.trafficTracer.capture.fields.targetSource',
  'settings.trafficTracer.capture.fields.configFile',
  'settings.trafficTracer.capture.fields.configTarget',
  'settings.trafficTracer.capture.fields.url',
  'settings.trafficTracer.capture.fields.domain',
  'settings.trafficTracer.capture.fields.duration',
  'settings.trafficTracer.capture.fields.network',
  'settings.trafficTracer.capture.fields.tunInterface',
  'settings.trafficTracer.capture.fields.physicalInterface',
  'settings.trafficTracer.capture.fields.chrome',
  'settings.trafficTracer.capture.fields.output',
  'settings.trafficTracer.capture.fields.cachePolicy',
  'settings.trafficTracer.capture.fields.analysisStorage',
  'settings.trafficTracer.capture.hints.configFile',
  'settings.trafficTracer.capture.hints.url',
  'settings.trafficTracer.capture.hints.domain',
  'settings.trafficTracer.capture.hints.output',
  'settings.trafficTracer.capture.hints.chrome',
  'settings.trafficTracer.capture.hints.cacheCold',
  'settings.trafficTracer.capture.hints.cacheWarm',
  'settings.trafficTracer.capture.hints.analysisStandard',
  'settings.trafficTracer.capture.hints.analysisFull',
  'settings.trafficTracer.capture.targetSources.manual',
  'settings.trafficTracer.capture.targetSources.config',
  'settings.trafficTracer.capture.values.cacheCold',
  'settings.trafficTracer.capture.values.cacheWarm',
  'settings.trafficTracer.capture.values.analysisStandard',
  'settings.trafficTracer.capture.values.analysisFull',
  'settings.trafficTracer.capture.options.packets',
  'settings.trafficTracer.capture.options.cdp',
  'settings.trafficTracer.capture.options.netlog',
  'settings.trafficTracer.capture.options.analyze',
  'settings.trafficTracer.capture.options.headless',
  'settings.trafficTracer.capture.locked',
  'settings.trafficTracer.jobs.capture',
  'settings.trafficTracer.jobs.analysis',
  'settings.trafficTracer.jobs.started',
  'settings.trafficTracer.jobs.restoredTime',
  'settings.trafficTracer.jobs.progressLog',
  'settings.trafficTracer.jobs.waiting',
  'settings.trafficTracer.jobs.jobId',
  'settings.trafficTracer.jobs.cancelTitle',
  'settings.trafficTracer.jobs.cancelDescription',
  'settings.trafficTracer.jobs.cancelReason',
  'settings.trafficTracer.sessions.title',
  'settings.trafficTracer.sessions.description',
  'settings.trafficTracer.sessions.checkEnvironment',
  'settings.trafficTracer.sessions.empty',
  'settings.trafficTracer.sessions.corrupt',
  'settings.trafficTracer.sessions.detailTitle',
  'settings.trafficTracer.sessions.details',
  'settings.trafficTracer.sessions.artifactsEmpty',
  ...
  'settings.trafficTracer.sessions.schema',
  'settings.trafficTracer.sessions.workerApi',
  'settings.trafficTracer.sessions.componentVersions',
  'settings.trafficTracer.sessions.artifactsTitle',
  'settings.trafficTracer.sessions.unknownSize',
  'settings.trafficTracer.sessions.startingAnalysis',
  'settings.trafficTracer.sessions.verifyPacketEvidence',
  'settings.trafficTracer.sessions.packetVerificationNotRequested',
  'settings.trafficTracer.sessions.chooseFolder',
  'settings.trafficTracer.sessions.clearFolder',
  'settings.trafficTracer.sessions.currentCapture',
  'settings.trafficTracer.sessions.noFolderSelected',
  'settings.trafficTracer.sessions.waitingForCaptureFolder',
  'settings.trafficTracer.sessions.emptyFolder',
  'settings.trafficTracer.sessions.splitChecking',
  'settings.trafficTracer.sessions.splitSummary',
  'settings.trafficTracer.sessions.splitMissing',
  'settings.trafficTracer.sessions.repairSplit',
  'settings.trafficTracer.sessions.splitJob',
  'settings.trafficTracer.sessions.splitStatus.unsplit',
  'settings.trafficTracer.sessions.splitStatus.complete',
  'settings.trafficTracer.sessions.splitStatus.complete_empty',
  'settings.trafficTracer.sessions.splitStatus.partial',
  'settings.trafficTracer.sessions.splitStatus.stale',
  'settings.trafficTracer.sessions.splitStatus.raw_missing',
  'settings.trafficTracer.sessions.splitStatus.ineligible',
  'settings.trafficTracer.flows.title',
  'settings.trafficTracer.flows.description',
  'settings.trafficTracer.flows.filter',
  'settings.trafficTracer.flows.noResults',
  'settings.trafficTracer.flows.noFilterResults',
  'settings.trafficTracer.flows.noPostTuple',
  'settings.trafficTracer.flows.shared',
  'settings.trafficTracer.flows.exclusive',
  'settings.trafficTracer.flows.unknown',
  'settings.trafficTracer.flows.sharedTooltip',
  'settings.trafficTracer.flows.match.matched',
  'settings.trafficTracer.flows.match.ambiguous',
  'settings.trafficTracer.flows.match.unmatched',
  'settings.trafficTracer.flows.match.legacy',
  'settings.trafficTracer.flows.detail.title',
  'settings.trafficTracer.flows.detail.sharedFlow',
  'settings.trafficTracer.flows.detail.sharedWarning',
  'settings.trafficTracer.flows.detail.preTuple',
  'settings.trafficTracer.flows.detail.postTuple',
  'settings.trafficTracer.flows.detail.missingPost',
  'settings.trafficTracer.flows.detail.correlation',
  'settings.trafficTracer.flows.detail.reason',
  'settings.trafficTracer.flows.detail.candidates',
  'settings.trafficTracer.flows.detail.flowId',
  'settings.trafficTracer.flows.detail.connectionId',
  'settings.trafficTracer.flows.detail.outerConnectionId',
  'settings.trafficTracer.flows.detail.requestContext',
  'settings.trafficTracer.flows.detail.resourceType',
  'settings.trafficTracer.flows.detail.relation',
  'settings.trafficTracer.flows.detail.requestIds',
  'settings.trafficTracer.flows.detail.noRequestIds',
  'settings.trafficTracer.flows.detail.packetCaptures',
  'settings.trafficTracer.flows.detail.packetCaptureScope',
  'settings.trafficTracer.flows.detail.confidence',
  'settings.trafficTracer.flows.detail.to',
  'settings.trafficTracer.flows.detail.host',
  'settings.trafficTracer.flows.columns.network',
  'settings.trafficTracer.flows.columns.session',
  'settings.trafficTracer.flows.columns.pre',
  'settings.trafficTracer.flows.columns.post',
  'settings.trafficTracer.flows.columns.match',
  'settings.trafficTracer.flows.columns.shared',
  'settings.trafficTracer.flows.columns.url',
  'settings.trafficTracer.flows.queryTitle',
  'settings.trafficTracer.flows.queryDescription',
  'settings.trafficTracer.flows.sourceIp',
  'settings.trafficTracer.flows.sourcePort',
  'settings.trafficTracer.flows.destinationIp',
  'settings.trafficTracer.flows.destinationPort',
  'settings.trafficTracer.flows.ipHint',
  'settings.trafficTracer.flows.sessionsAvailable',
  'settings.trafficTracer.flows.found',
  'settings.trafficTracer.validation.ip',
  'settings.trafficTracer.validation.port',
  'settings.trafficTracer.validation.url',
  'settings.trafficTracer.validation.domain',
  'settings.trafficTracer.validation.duration',
  'settings.trafficTracer.validation.configFile',
  'settings.trafficTracer.validation.tunInterface',
  'settings.trafficTracer.validation.physicalInterface',
  'settings.trafficTracer.validation.output',
  'settings.trafficTracer.validation.chrome',
